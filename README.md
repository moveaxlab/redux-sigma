...
<p>developed with :heart: by <a href="https://moveax.it" target="_blank"><img alt="moveax" verticalalign="text-top" height="16px" src="https://github.com/moveaxlab/redux-sigma/blob/master/assets/moveax.png?raw=true"></a></p>
